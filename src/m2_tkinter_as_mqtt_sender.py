...
def main():
    ...
    forward_button['command'] = lambda: forward(mqtt_client, right_speed_entry.get(), left_speed_entry.get())
    ...
    back_button['command'] = lambda: backward(mqtt_client,left_speed_entry.get(), right_speed_entry.get())
...
def forward(mqtt_client, speed_right, speed_left):
    mqtt_client.send_message("forward",[speed_left, speed_right])

def backward(mqtt_client, left, right):
